...
def removing_task():
    try:
        index_p=list1.curselection()[0]
        list1.delete(index_p)
...
list1.pack()
todo_list=tkinter.Listbox(list1,height=30,width=60)
...
task_add=tkinter.Entry(n,width=70)
task_add.pack()

add_button=tkinter.Button(n,text="Click To Add Task",font=("arial",30,"bold"),background="Orange",width=50,command=adding_task)
add_button.pack()

remove_button=tkinter.Button(n,text="Click To Delete Task",font=("arial",30,"bold"),background="blue",width=50,command=removing_task)
remove_button.pack()

loading_button=tkinter.Button(n,text="Click To Load Task",font=("arial",30,"bold"),background="yellow",width=50,command=loading_task)
loading_button.pack()

save_button=tkinter.Button(n,text="Click to save task",font=("arial",30,"bold"),background="green",width=50,command=save_task)
save_button.pack()
